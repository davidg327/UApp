        ...
        <Formik
          ...
          {({errors, touched, handleSubmit, values, setFieldValue}) => (
            <View>
              ...
              <PrincipalText
                text={'Puntos aproximados de ganancia'}
                styles={orderStyles.textPoints}
              />
              <PrincipalText text={'500 pts'} styles={orderStyles.points} />
              <PrincipalText
                text={
                  '*Estos puntos pueden cambiar cuando se validen al entregarse'
                }
                styles={orderStyles.textMessage}
              />
              <CalendarsComponent
                valueChange={'date'}
                change={() => console.log('')}
